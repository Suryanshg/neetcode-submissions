...
class Solution:
    def buildTree(self, preorder: List[int], inorder: List[int]) -> Optional[TreeNode]:
        ...
        # preorder gets remaining elements after first mid characters starting from idx 1
        # all the way to the end
        #
        # inorder gets all elements starting from mid + 1 idx (skipping mid as it has root node)
        # all the way to the end
